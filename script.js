...
const createCard = (book) => {
  ...
  let overview = book.overview.substring(1, 75) +"...";
  div.innerHTML = `
...
const displayCart = () => {
  ...
  const getCartId = document.getElementById('cart');
  getCartId.innerHTML = "";
  cart.forEach((book) => {
    const div = createCard(book);
...
const displayWishlist = () => {
  const wishlist = getWishlistItems();
   const getWishlistId = document.getElementById("wishlist");
   getWishlistId.innerHTML = '';
